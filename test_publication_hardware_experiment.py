"""Offline integrity tests for the frozen publication experiment.
...
import publication_hardware_experiment as experiment
...
class KernelAndAnalysisTests(unittest.TestCase):
    ...
    def test_publication_figures_render_all_formats(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                ...
                experiment._publication_figures(rows)
                ...
                experiment._publication_latex_tables(
                    aggregate,
                    classical,
                    anchors,
                    intervals,
                ...
                experiment._write_publication_report(
            ...
            report = analysis / "publication_results.txt"
